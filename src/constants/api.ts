...
export const FUNCOIN_URL = '/api/v1/funcoin'
export const GAMIFICATION_URL = '/api/v1/admin/gamification'
export const NOTIFICATIONS_URL = '/api/v1/admin/notifications'
